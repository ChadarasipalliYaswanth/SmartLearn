...
var OutlinedInput = React9.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime7.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime7.jsxs)(React9.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
true ? Paper.propTypes = {
   ...
   * @default 'elevation'
   */
  variant: import_prop_types26.default.oneOfType([import_prop_types26.default.oneOf(["elevation", "outlined"]), import_prop_types26.default.string])
} : void 0;
...
var Popover = React31.forwardRef(function Popover2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopover"
  });
  ...
  const getAnchorOffset = React31.useCallback(() => {
  ...
  const getTransformOrigin = React31.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React31.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React31.useState(open);
  const setPositioningStyles = React31.useCallback(() => {
  ...
  React31.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
...
var Menu = React32.forwardRef(function Menu2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiMenu"
  });
  ...
  const menuListActionsRef = React32.useRef(null);
  ...
  let activeItemIndex = -1;
  React32.Children.map(children2, (child, index) => {
...
var SelectInput = React34.forwardRef(function SelectInput2(props, ref) {
  ...
  const childrenArray = React34.Children.toArray(children2);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime23.jsxs)(React34.Fragment, {
...
true ? TextField.propTypes = {
  ...
  slotProps: import_prop_types32.default.shape({
    formHelperText: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    htmlInput: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    input: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
    inputLabel: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
  ...
  slots: import_prop_types32.default.shape({
    formHelperText: import_prop_types32.default.elementType,
    htmlInput: import_prop_types32.default.elementType,
    input: import_prop_types32.default.elementType,
    inputLabel: import_prop_types32.default.elementType,
...
true ? TabScrollButton.propTypes = {
   ...
   */
  direction: import_prop_types41.default.oneOf(["left", "right"]).isRequired,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   */
  orientation: import_prop_types41.default.oneOf(["horizontal", "vertical"]).isRequired,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   * @default {}
...
var Tabs = React51.forwardRef(function Tabs2(inProps, ref) {
  ...
  let childIndex = 0;
  const children2 = React51.Children.map(childrenProp, (child) => {
...
true ? Tabs.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types43.default.bool,
  /**
   ...
   * @default false
   */
  centered: import_prop_types43.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["primary", "secondary"]), import_prop_types43.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types43.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types43.default.oneOf(["auto", false, true]),
  /**
  ...
  slotProps: import_prop_types43.default.shape({
    ...
    indicator: import_prop_types43.default.oneOfType([import_prop_types43.default.func, import_prop_types43.default.object]),
    ...
    scrollbar: import_prop_types43.default.oneOfType([import_prop_types43.default.func, import_prop_types43.default.object]),
    scrollButtons: import_prop_types43.default.oneOfType([import_prop_types43.default.func, import_prop_types43.default.object]),
    scroller: import_prop_types43.default.oneOfType([import_prop_types43.default.func, import_prop_types43.default.object]),
  ...
  slots: import_prop_types43.default.shape({
    ...
    EndScrollButtonIcon: import_prop_types43.default.elementType,
    indicator: import_prop_types43.default.elementType,
    list: import_prop_types43.default.elementType,
    root: import_prop_types43.default.elementType,
    scrollbar: import_prop_types43.default.elementType,
    scrollButtons: import_prop_types43.default.elementType,
    scroller: import_prop_types43.default.elementType,
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types43.default.object,
  /**
   ...
   * @default {}
   */
  TabScrollButtonProps: import_prop_types43.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types43.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types43.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types43.default.bool
} : void 0;
...
var Popper3 = React56.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopper"
...
var ListItem = React60.forwardRef(function ListItem2(inProps, ref) {
  ...
  const children2 = React60.Children.toArray(childrenProp);
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types50.default.node, (props) => {
    const children2 = React60.Children.toArray(props.children);
...
var Chip = React62.forwardRef(function Chip2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React62.useRef(null);
  ...
  const ownerState = {
    ...
    size,
    color,
    iconColor: React62.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  };
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && React62.isValidElement(deleteIconProp) ? React62.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && React62.isValidElement(avatarProp)) {
    avatar = React62.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && React62.isValidElement(iconProp)) {
    icon = React62.cloneElement(iconProp, {
      className: clsx_default(classes.icon, iconProp.props.className)
    });
  }
  if (true) {
...
true ? Dialog.propTypes = {
   ...
   * @default true
   */
  "aria-modal": import_prop_types56.default.oneOfType([import_prop_types56.default.oneOf(["false", "true"]), import_prop_types56.default.bool]),
  /**
   * A backdrop component. This prop enables custom backdrop rendering.
   * @deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.
   * Use the `slots.backdrop` prop to make your application ready for the next version of Material UI.
   ...
   * @default false
   */
  fullScreen: import_prop_types56.default.bool,
  /**
   ...
   * @default 'sm'
   */
  maxWidth: import_prop_types56.default.oneOfType([import_prop_types56.default.oneOf(["xs", "sm", "md", "lg", "xl", false]), import_prop_types56.default.string]),
  /**
   * Callback fired when the backdrop is clicked.
   * @deprecated Use the `onClose` prop with the `reason` argument to handle the `backdropClick` events.
   */
  onBackdropClick: import_prop_types56.default.func,
  /**
   * @ignore
   */
   ...
   * @default Paper
   */
  PaperComponent: import_prop_types56.default.elementType,
  /**
   * Props applied to the [`Paper`](https://mui.com/material-ui/api/paper/) element.
   * @default {}
   ...
   * @default 'paper'
   */
  scroll: import_prop_types56.default.oneOf(["body", "paper"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types56.default.shape({
    ...
    container: import_prop_types56.default.oneOfType([import_prop_types56.default.func, import_prop_types56.default.object]),
  ...
  slots: import_prop_types56.default.shape({
    ...
    container: import_prop_types56.default.elementType,
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZCMFM4LP.js.map
